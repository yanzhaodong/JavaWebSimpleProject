...
public class StringUtil {
     ...
     * 生成随机文字
     * @param length           文字的长度
     * @param length           文字的取字范围，ch代表中文，n代表数字，l代表英文，nl代表数字加英文，默认数字加英文
     * @return: String  	   生成的文字      
     */
	public static String getRandomChar(int length, String... createTypeFlag) {
        //汉字
